    ...
    <div className={cx("gt", narrow && "narrow")}>
      ...
      <div className="gt-stage">
        ...
        <div className="gt-rail">
          ...
          <div className="gt-status serif" aria-live="polite">{statusLine}</div>
        ...
        <div className="gt-paperwrap">
          <div className="gt-paper" aria-live="polite" aria-atomic="false"
            aria-label={complete ? "生成完成的草稿" : "AI 正在逐字书写的草稿"}>
            {complete && (
      ...
      {complete && (
        <div className="gt-veil">
          <div className="gt-pop" role="status" aria-live="polite">
            {GT_CONFETTI.map((c, i) => (
      ...
      {error && (
        <div className="gt-veil">
          <div className="gt-pop" role="alertdialog" aria-modal="true" aria-label="生成未完成">
            {noProvider ? (
              <>
