...
class RenderContext:
    ...
    Attributes:
        ...
        profile: sanitization profile name ("wechat" default; "generic"/"web"
            for a relaxed web-preview profile). Threaded into HtmlRenderer so
            the inner sanitize pass agrees with the outer pipeline pass.
    """
