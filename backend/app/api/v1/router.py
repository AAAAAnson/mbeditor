...
from app.api.v1.mbdocs import router as mbdocs_router
from app.api.v1.effects import router as effects_router
from app.api.v1.settings import router as settings_router
from app.api.v1.credentials import router as credentials_router
from app.api.v1.settings_ai import router as settings_ai_router
...
api_router.include_router(mbdocs_router)
api_router.include_router(effects_router)
api_router.include_router(settings_router)
api_router.include_router(credentials_router)
api_router.include_router(settings_ai_router)
